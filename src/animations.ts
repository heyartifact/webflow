...
const SAMPLE_QUESTION_JULIE_ANIMATION: AnimationName = 'sample-question-julie'
const SAMPLE_QUESTION_MIKE_ANIMATION: AnimationName = 'sample-question-mike'
const SAMPLE_QUESTION_PRIA_ANIMATION: AnimationName = 'sample-question-pria'
const SAMPLE_QUESTION_RUTHIE_ANIMATION: AnimationName = 'sample-question-ruthie'
const SAMPLE_QUESTION_ANIMATIONS = [
...
const ANIMATIONS: Record<AnimationName, AnimationInfo> = {
    ...
    [SAMPLE_QUESTION_ANNA_ANIMATION]: {
        cleanupAnimation: () => sampleQuestionAnimationCleanup(SAMPLE_QUESTION_ANNA_ANIMATION),
        duration: 7405,
